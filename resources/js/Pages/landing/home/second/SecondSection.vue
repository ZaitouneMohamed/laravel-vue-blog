                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="blog-single.html">
                                    <img src="assets/landing/images/fashion/img-1.jpg" alt="" class="img-fluid w-100">
                                </a>
                                <span
                                    class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">Travel</span>
                            ...
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="blog-single.html">
                                    <img src="assets/landing/images/fashion/img-lg-2.jpg" alt="" class="img-fluid w-100">
                                </a>
                                <span
                                    class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">Lifestyle</span>
                            ...
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="blog-single.html">
                                    <img src="assets/landing/images/fashion/img-7.jpg" alt="" class="img-fluid w-100">
                                </a>
                                <span
                                    class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">fashion</span>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="blog-single.html">
                                    <img src="assets/landing/images/fashion/img-lg-1.jpg" alt="" class="img-fluid w-100">
                                </a>
                                <span
                                    class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">Explore</span>
                            ...
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="blog-single.html">
                                    <img src="assets/landing/images/fashion/img-md-1.jpg" alt="" class="img-fluid w-100">
                                </a>
                                <span
                                    class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">lifestyle</span>
                            ...
                            <article class="post-grid mb-5">
                                <a class="post-thumb mb-4 d-block" href="blog-single.html">
                                    <img src="assets/landing/images/fashion/img-lg-4.jpg" alt="" class="img-fluid w-100">
                                </a>
                                <span
                                    class="letter-spacing cat-name font-extra text-uppercase font-sm text-color ">Travel</span>
                        ...
                        <div class="sidebar-wrap mt-5 mt-lg-0">
                            <div class="sidebar-widget about mb-5 text-center p-3">
                                <div class="about-author">
                                    <img src="assets/landing/images/author.jpg" alt="" class="img-fluid">
                                </div>
                                ...
                                <p>I'm Liam, last year I decided to quit my job and travel the world. You can follow my
                                    journey on this
                                    blog!</p>
                                <img src="assets/landing/images/liammason.png" alt="" class="img-fluid">
                            </div>
                            ...
                            <div class="sidebar-widget mb-5 ">
                                ...
                                <div class="sidebar-post-item-big">
                                    <a href="blog-single.html"><img src="assets/landing/images/news/img-1.jpg" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="media border-bottom py-3 sidebar-post-item">
                                    <a href="#"><img class="mr-4" src="assets/landing/images/news/thumb-1.jpg" alt=""></a>
                                ...
                                <div class="media py-3 sidebar-post-item">
                                    <a href="#"><img class="mr-4" src="assets/landing/images/news/thumb-2.jpg" alt=""></a>
                                    <div class="media-body">
                                        <span class="text-muted letter-spacing text-uppercase font-sm">September 10,
                                            2019</span>
